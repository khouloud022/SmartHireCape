...
import { Container, Row, Col, Card, Button, Badge, ProgressBar, Dropdown, Table } from 'react-bootstrap';
              ...
              <Col>
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="text-muted mb-0">Bienvenue, Candidat</p>
                  </div>
                  <Link to="/CandidatSubmission" style={{ textDecoration: 'none', color: 'inherit' }}>
                  <Button variant="primary" className="px-4" style={{ backgroundColor: '#2a5bd7',borderColor: '#2a5bd7'}}>
                    <i className="fas fa-plus me-2"></i>Nouvelle soumission
                  </Button>
                  </Link>
                </div>
              </Col>
                      ...
                      <Table hover className="mb-0">
                        <thead className="bg-light">
                          <tr>
                            ...
                            <th className="border-0">Candidats</th>
            ...
            <Row>
              <Col>
                <Card className="shadow-sm border-0" style={{borderRadius: '12px'}}>
                  <Card.Header className="bg-white border-0">
                    <div className="d-flex justify-content-between align-items-center">
                      <h5 className="mb-0 text-dark">Derniéres soumissions</h5>
                      <div>
                      ...
                      <Table hover className="mb-0">
                        <thead className="bg-light">
                          <tr>
                            ...
                            <th className="border-0">Poste</th>
                            <th className="border-0">Niveau</th>
